                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{route('admin.user.add')}}" class="btn btn-success btn-md">Add</a>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table">
                                    ...
                                    @foreach($users as $user)
                                        ...
                                        <tr>
                                            ...
                                            <td width="200px">
                                                <a href="{{route('admin.user.edit', $id_user)}}" title="" class="btn btn-primary"><i class="fa fa-edit "></i> Edit</a>
                                                <a href="{{route('admin.user.del', $id_user)}}" title="" class="btn btn-danger"><i class="fa fa-pencil"></i> Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
