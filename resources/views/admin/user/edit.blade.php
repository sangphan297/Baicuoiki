        ...
        <div class="container-fluid">
            ...
            <div class="row">
              ...
              <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form class="form-horizontal" method="post" action="{{route('admin.user.edit', $user->id_user) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <label class="col-sm-2 form-control-label">Email</label>
                            <div class="col-sm-10">
                                <div class="form-group-material">
                                    <input id="Email" type="email" name="email"  class="input-material" value="{{ $user->email }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group-material">
                                    <input id="Fullname" type="text" name="fullname"  class="input-material" value="{{ $user->fullname }}">
