      ...
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
           <div class="logo text-uppercase"><span>Login to</span><strong class="text-primary">the Recruitment system</strong></div>
            <p></p>
            <form method="post" action="{{ route('auth.auth.login_candidate')}}" class="text-left form-validate">
              @csrf
              <div class="form-group-material">
                <input id="login-username" type="text" name="email" required data-msg="Please enter your email" class="input-material" placeholder="Email">
              ...
              @endif
            <a href="{{ route('auth.auth.forgetpass')}}" class="forgot-pass">Forgot password?</a>
          </div>
        </div>
      </div>
    </div>
