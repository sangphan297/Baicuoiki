        ...
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
           <div class="logo text-uppercase"><strong class="text-primary">Please enter your information</strong></div>
            <p></p>
            <form method="post" action="{{ route('auth.auth.forgetpass')}}" class="text-left form-validate">
              @csrf
              <div class="form-group-material">
                <input id="login-password" type="email" name="email" required data-msg="Please enter your password" class="input-material" placeholder="Email">
